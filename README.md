...
Forked from [yalibian/i3-windows] https://github.com/yalibian/i3-windows which was forked from [pmb6tz/windows-desktop-switcher](https://github.com/pmb6tz/windows-desktop-switcher) and [Depau/swin](https://github.com/Depau/swin)[jnoynaert/window-mover](https://github.com/jnoynaert/window-mover), to minimally reproduce some desirable i3/sway-like behavior on Windows.
...
2. Create a shortcut to the `i3wm.ahk` file here
...
$A = New-ScheduledTaskAction -Execute "PATH\TO\i3wm.ahk"
